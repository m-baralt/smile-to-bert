...
class SMILESDataset(Dataset):
    def __init__(self, smiles_list, tokenizer, seq_len):
...
def prepare_data(smiles_list, tokenizer, 
...
properties_names = ["H_bond_acceptor", "H_bond_donor", "Rotatable_bond", "Exact_mass", "TPSA", "Heavy_atom", "LogP"]
...
smiles_embed = {smiles[0]: matrix for smiles, matrix in zip(smiles_list, embedding_list)}
